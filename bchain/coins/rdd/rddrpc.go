...
func (g *ReedRPC) Initialize() error {
	...
	g.Parser = NewReddParser(params, g.ChainConfig)
...
func (g *ReedRPC) GetBlock(hash string, height uint32) (*bchain.Block, error) {
	var err error
	if hash == "" && height > 0 {
...
func (g *ReedRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
